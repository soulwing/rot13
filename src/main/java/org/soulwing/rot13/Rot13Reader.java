...
public class Rot13Reader extends Reader {
  ...
  /**
   * A reader that unconditionally performs a ROT-13 operation on all input
   * that appears on the given reader.
  ...
  /**
   * A reader that performs a ROT-13 operation on input that appears
   * on the given reader, assuming that the first (newline terminated) line of
   * the file exactly matches the given header.  If the first line of the file
   * does not match the given header string, the resulting reader does not
   * rotate the text.
   * <p>
